...
public interface SqlList {
    ...
    String INSERT_SECURITY_SQL = "INSERT INTO security(id, password, role, user_id, username) VALUES (DEFAULT, :password, :role, :user_id, :username)";
    String SELECT_USERS_SQL = "SELECT * FROM users";
    String SELECT_USER_BY_ID_SQL = "SELECT * FROM users WHERE id = ?";
    String SELECT_SECURITY_BY_USERNAME = "SELECT * FROM security WHERE username = :username";
